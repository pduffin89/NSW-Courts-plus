...
`scripts/validate_extension_pdf_generation.py` runs the real Manifest V3 background-worker PDF code in a Node harness and applies the same 336-case field/text/date/signature/checkbox matrix to extension-generated PDFs.
