...
const featureMatrix = [
  ...
  feature('Total smoke, CI, release packaging, provenance, and release cleanliness', [
    'scripts/smoke.mjs', 'scripts/live_smoke.mjs', 'scripts/live_extension_smoke.py', 'scripts/release_extension_smoke.py', 'scripts/package_extension.mjs', 'scripts/package_determinism.mjs', 'scripts/verify_ci_artifact_parity.mjs', 'scripts/completion_audit.mjs', 'scripts/evidence_manifest_audit.mjs', '.github/workflows/courtlens-v2.yml'
  ], [
