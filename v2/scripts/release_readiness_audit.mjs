...
if (!fileContains('scripts/completion_audit.mjs', ['completion-audit.json', 'ci-artifact-parity.json', 'live-smoke.json', 'standalone-live-smoke-artifact.json', 'operator-live-smoke.json', 'credentialedProviderSmoke', 'operatorNswWorkflowSmoke'])) fail('completion audit script is missing required prompt-to-artifact/manual gate checks');
...
if (!fileContains('scripts/write_checksums.mjs', ['screenshots/01-overview.png', 'screenshots/02-research.png', 'screenshots/03-documents.png', 'screenshots/04-settings.png', 'live-smoke.json', 'operator-live-smoke.json', 'ci-artifact-parity.json', 'standalone-live-smoke-artifact.json', 'completion-audit.json'])) fail('checksum manifest must include release screenshots and optional smoke/parity/completion evidence when present');
