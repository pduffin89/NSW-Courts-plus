...
if (!fileContains('docs/release-readiness.md', ['verify:ci-artifact-parity', 'argus-delta-courtlens', 'byte-for-byte', 'docs/web-store-listing.md', 'docs/manual-verification.md', 'npm run audit:completion', 'npm run audit:evidence-manifest', 'artifacts/ci-artifact-parity.json', 'live-smoke.json', 'argus-delta-courtlens-live-smoke'])) fail('release-readiness docs do not describe CI artifact parity verification, store listing handoff, manual evidence runbook, completion audit, evidence manifest audit, live-smoke provenance, standalone live-smoke artifact, and parity evidence artifact');
...
if (!fileContains('scripts/write_checksums.mjs', ['screenshots/01-overview.png', 'screenshots/02-research.png', 'screenshots/03-documents.png', 'screenshots/04-settings.png', 'live-smoke.json', 'operator-live-smoke.json', 'ci-artifact-parity.json', 'completion-audit.json'])) fail('checksum manifest must include release screenshots and optional smoke/parity/completion evidence when present');
