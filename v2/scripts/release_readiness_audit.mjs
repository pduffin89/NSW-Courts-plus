...
if (!fileContains('docs/release-readiness.md', ['verify:ci-artifact-parity', 'argus-delta-courtlens', 'byte-for-byte', 'docs/web-store-listing.md', 'docs/manual-verification.md', 'npm run audit:completion', 'artifacts/ci-artifact-parity.json', 'live-smoke.json'])) fail('release-readiness docs do not describe CI artifact parity verification, store listing handoff, manual evidence runbook, completion audit, live-smoke provenance, and parity evidence artifact');
