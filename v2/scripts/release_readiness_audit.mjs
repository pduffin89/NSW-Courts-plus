...
if (!fileContains('scripts/verify_manual_verification.mjs', ['manual-verification.json', 'manual-verification-audit.json', '--require-all'])) fail('manual verification evidence verifier is missing required checks');
