...
if (!fileContains('scripts/evidence_manifest_audit.mjs', ['SHA256SUMS', 'optionalEntries', 'current HEAD'])) fail('evidence manifest audit script is missing checksum/provenance checks');
