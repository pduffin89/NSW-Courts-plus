...
if (!fileContains('docs/release-readiness.md', ['verify:ci-artifact-parity', 'verify:live-smoke-artifact', 'argus-delta-courtlens', 'byte-for-byte', 'docs/web-store-listing.md', 'docs/manual-verification.md', 'npm run audit:completion', 'npm run audit:evidence-manifest', 'artifacts/ci-artifact-parity.json', 'live-smoke.json', 'argus-delta-courtlens-live-smoke'])) fail('release-readiness docs do not describe CI artifact parity verification, standalone live-smoke artifact verification, store listing handoff, manual evidence runbook, completion audit, evidence manifest audit, live-smoke provenance, standalone live-smoke artifact, and parity evidence artifact');
