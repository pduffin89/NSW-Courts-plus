...
if (!fileContains('scripts/completion_audit.mjs', ['completion-audit.json', 'ci-artifact-parity.json', 'live-smoke.json', 'operator-live-smoke.json', 'credentialedProviderSmoke', 'operatorNswWorkflowSmoke'])) fail('completion audit script is missing required prompt-to-artifact/manual gate checks');
