...
if (!fileContains('docs/release-readiness.md', ['verify:ci-artifact-parity', 'argus-delta-courtlens', 'byte-for-byte', 'docs/web-store-listing.md', 'docs/manual-verification.md', 'npm run audit:completion', 'npm run audit:evidence-manifest', 'artifacts/ci-artifact-parity.json', 'live-smoke.json'])) fail('release-readiness docs do not describe CI artifact parity verification, store listing handoff, manual evidence runbook, completion audit, evidence manifest audit, live-smoke provenance, and parity evidence artifact');
