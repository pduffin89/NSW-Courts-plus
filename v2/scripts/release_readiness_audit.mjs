...
if (!fileContains('scripts/completion_audit.mjs', ['completion-audit.json', 'ci-artifact-parity.json', 'live-smoke.json', 'standalone-live-smoke-artifact.json', 'operator-live-smoke.json', 'operator-smoke-verification.json', 'manual-verification-audit.json', 'credentialedProviderSmoke', 'operatorNswWorkflowSmoke'])) fail('completion audit script is missing required prompt-to-artifact/manual gate checks');
if (!fileContains('scripts/verify_live_smoke_artifact.mjs', ['argus-delta-courtlens-live-smoke', '--require-credentialed', 'standalone-live-smoke-artifact.json'])) fail('standalone live-smoke artifact verifier is missing required checks');
